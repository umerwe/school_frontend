...
export default function ChangeTeacherPassword() {
  ...
  const [changeTeacherPassword, { isLoading: isSubmitting }] = useChangePasswordMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    const messageKey = "changeTeacherPassword";
          ...
          <div className="flex items-center gap-3 mb-1 md:mb-0">
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-gray-500 font-nunito">
                Update password for {capitalizeName(teacher.name)}
              </p>
            </div>
          </div>
        </div>
