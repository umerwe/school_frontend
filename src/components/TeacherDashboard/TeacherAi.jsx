      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 bg-white rounded-xl shadow-sm border border-indigo-200 p-3 py-6 sm:px-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Teacher Assistant</h1>
            ...
            <div className="mt-6 pt-5 border-t border-indigo-200">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  <span>Specify the class or section in your query</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-indigo-500">•</span>
                  <span>Ask about attendance, marks, or student details</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-indigo-500">•</span>
                  <span>Request subject or class performance summaries</span>
                </li>
              </ul>
            </div>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="relative">
                    <textarea
                      ...
                      rows={4}
                      placeholder={`e.g., "What's the attendance percentage for Class 9A?", "Show marks analysis for Physics mid-term", "List students in Class 10B"`}
                      value={prompt}
