      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            The payment process for {voucherId ? `Voucher #${voucherId}` : "your voucher"} was not
            completed. You can return to your vouchers and try again whenever you're ready.
          </p>
          <button
        ...
        <div className="bg-gray-50 px-6 py-4 text-center">
          <p className="text-xs text-gray-500">
            Need help? Contact our support team at uemyy1@gmail.com
          </p>
        </div>
      </div>
    </div>
