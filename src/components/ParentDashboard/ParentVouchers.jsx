...
import { useCreateCheckoutSessionMutation, 
    useGetParentDashboardSummaryQuery } from "../../store/slices/parentDashboardApi";
...
export default function ParentVouchers() {
    ...
    // Update vouchers when selected student changes
    useEffect(() => {
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4">
                                                    <button
                                                        ...
                                                        disabled={statusInfo.disabled || isPaymentLoading}
                                                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 ${statusInfo.disabled || isPaymentLoading ? 'bg-gray-300 text-gray-600 cursor-not-allowed' : 'bg-indigo-600 text-white hover:bg-indigo-700'}`}
                                                        style={{ fontFamily: "Nunito, sans-serif" }}
                                                    >
                                                        {isPaymentLoading ? 'Processing...' : statusInfo.buttonText}
                                                    </button>
                                                </td>
                                            </tr>
                                        );
