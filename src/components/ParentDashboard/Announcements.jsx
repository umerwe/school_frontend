    ...
    return (
      <div className="p-6 bg-gray-100 min-h-screen">
        ...
        <div className="space-y-6">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="bg-white rounded-xl shadow p-5 animate-pulse h-20 border border-gray-200">
              ...
              {expandedId === a._id && (
                <div className="px-6 pb-6 pt-2 bg-gray-100 border-t border-indigo-100">
                  <div className="flex flex-col">
                    <div className="inline-block px-3 py-1 text-xs rounded-full mb-3 self-start font-medium capitalize tracking-wide whitespace-nowrap items-center">
                    </div>
