...
import { Brain, Send, CheckCircle, Loader2, Copy, User, BookOpen, DollarSign, Calendar } from 'lucide-react';
...
const StudentAi = () => {
  ...
  const quickPrompts = [
    { icon: <Calendar size={16} />, text: "Show my attendance summary" },
    { icon: <BookOpen size={16} />, text: "What are my current grades?" },
    { icon: <DollarSign size={16} />, text: "Check my fee voucher status" },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Student Assistant</h1>
              <p className="text-gray-500">AI-powered insights for your academic journey</p>
            </div>
          </div>
        </div>
            ...
            <div className="mt-6 pt-5 border-t border-gray-200">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  <span>Ask about your attendance, grades, or fees</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-indigo-500">•</span>
                  <span>Request details about your class or teachers</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-indigo-500">•</span>
                  <span>Be specific, e.g., "Show my math grades"</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="p-5 border-b border-gray-200 bg-gray-50">
                <h2 className="font-semibold text-gray-800">Ask About Your Studies</h2>
              </div>
              <div className="p-5">
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="relative">
                    <textarea
                      ...
                      rows={4}
                      placeholder={`e.g., "What's my attendance this month?", "Show my grades for Physics", "Are my fee vouchers paid?", "Who is my class teacher?"`}
                      value={prompt}
