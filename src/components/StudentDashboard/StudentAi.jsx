      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 bg-white rounded-xl shadow-sm border border-indigo-200 p-3 py-6 sm:px-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Student Assistant</h1>
              <p className="text-sm sm:text-md text-gray-500 -mt-0.5">AI-powered assistant for your academic needs</p>
            </div>
          </div>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="relative">
                    <textarea
                      ...
                      rows={4}
                      placeholder="e.g., 'What's my attendance this month?', 'Show my grades for Physics', 'Are my fee vouchers paid?'"
                      value={prompt}
