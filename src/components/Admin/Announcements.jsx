...
export default function Announcements() {
  ...
  // Fetch announcements from dashboard summary
  const { data: announcementsData, isLoading, error } = useGetDashboardSummaryQuery(undefined, {
    selectFromResult: ({ data, isLoading, error }) => ({
      data: Array.isArray(data?.announcements) ? data.announcements : [],
      isLoading,
      error,
    }),
  });
